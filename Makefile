...
deploy_desktop: build_desktop
	...
	rsync -avz --delete ./dist/vacay/osx32/vacay.zip deploy@54.86.1.162:/home/deploy/vacay/desktop/osx32/vacay.zip
	rsync -av --delete ./desktop/package.json deploy@54.86.1.162:/home/deploy/vacay/desktop/package.json
